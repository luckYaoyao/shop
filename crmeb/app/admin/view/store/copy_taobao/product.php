                        ...
                        <div class="layui-input-block">
                            <div class="radio i-checks" style="display:inline;margin-left: 16px;">
                                <label class="" style="padding-left: 0;">
                                    <input style="position: relative;top: 1px;left: 3px;" checked="checked" v-model="type" type="radio" value="taobao" name="type">
                                    淘宝</label>
                            </div>
                            <div class="radio i-checks" style="display:inline;margin-left: 16px;">
                                <label class="" style="padding-left: 0;">
                                    <input style="position: relative;top: 1px;left: 3px;" checked="checked" v-model="type" type="radio" value="tmall" name="type">
                                    天猫</label>
                            </div>
                            <div class="radio i-checks" style="display:inline;margin-left: 16px;">
                                <label class="" style="padding-left: 0;">
                                    <input style="position: relative;top: 1px;left: 3px;" checked="checked" v-model="type" type="radio" value="jd" name="type">
                                    京东</label>
                            </div>
                            <div class="radio i-checks" style="display:inline;margin-left: 16px;">
                                <label class="" style="padding-left: 0;">
                                    <input style="position: relative;top: 1px;left: 3px;" checked="checked" v-model="type" type="radio" value="pdd" name="type">
                                    拼多多</label>
                            </div>
                            <div class="radio i-checks" style="display:inline;margin-left: 16px;">
                                <label class="" style="padding-left: 0;">
                                    <input style="position: relative;top: 1px;left: 3px;" checked="checked" v-model="type" type="radio" value="suning" name="type">
                                    苏宁</label>
                            </div>
                            <div class="radio i-checks" style="display:inline;margin-left: 16px;">
                                <label class="" style="padding-left: 0;">
                                    <input style="position: relative;top: 1px;left: 3px;" checked="checked" v-model="type" type="radio" value="1688" name="type">
                                    1688</label>
                            </div>
                        </div>
                    </div>
        ...
        new Vue({
            ...
            methods:{
                checkUrl:function () {
                    ...
                    this.loading=true;
                    layList.basePost(layList.U({a:'get_product_info'}),{type:this.type,link:this.link},function (res) {
                        this.loading=false;
                        this.linkhistory='';
