<template>
  <div>
    <el-card :bordered="false" shadow="never" class="ivu-mt listbox">
      <el-tabs v-model="userFrom.user_type" @tab-click="onClickTab" class="mb10">
        ...
        <el-row :gutter="24">
          <el-col v-bind="grid">
            <el-form-item label="用户搜索：" label-for="nickname">
              <el-input v-model="userFrom.nickname" placeholder="请输入用户" element-id="nickname" clearable>
      ...
      <el-row :gutter="24" justify="space-between" class="mt20">
        <el-col :span="24">
          <el-button v-auth="['admin-user-save']" type="primary" class="mr10" @click="edit({ uid: 0 })"
            >添加用户</el-button
          >
          <el-button v-auth="['admin-user-coupon']" class="mr10" @click="onSend">发送优惠券</el-button>
          <el-button
          ...
          <el-button v-auth="['admin-user-group_set']" class="mr10" @click="setGroup">批量设置分组</el-button>
          <el-button v-auth="['admin-user-set_label']" class="mr10" @click="setLabel">批量设置标签</el-button>
          <el-button class="mr10" icon="ios-share-outline" @click="exportList">导出</el-button>
      ...
      >
        ...
        <el-table-column label="操作" fixed="right" width="120">
          <template slot-scope="scope">
            ...
            <template v-else>
              <div v-if="scope.row.is_del == 1" style="color: red">已注销</div>
            </template>
          </template>
        </el-table-column>
      </el-table>
