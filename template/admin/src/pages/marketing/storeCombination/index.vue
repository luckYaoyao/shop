      ...
      >
        <el-row :gutter="24">
          <el-col v-bind="grid">
            <el-form-item label="拼团状态：" clearable>
              <el-select v-model="formValidate.is_show" placeholder="请选择" clearable @change="userSearchs">
        ...
        <el-row>
          <el-button
            ...
            >添加拼团商品</el-button
          >
          <el-button v-auth="['export-storeCombination']" class="export" icon="ios-share-outline" @click="exports"
            >导出</el-button
          >
        </el-row>
      </el-form>
      ...
      >
        ...
        <el-table-column label="操作" fixed="right" width="170">
          <template slot-scope="scope">
            ...
            <a @click="del(scope.row, '删除拼团商品', index)">删除</a>
            <el-divider direction="vertical"></el-divider>
