      ...
      <el-card :bordered="false" shadow="never" class="ivu-mt">
        <el-row>
          <el-col :span="24">
            ...
            <el-radio-group v-model="formValidate.upload_type" @change="changeSave">
            ...
            <div class="content">
              ...
              <div v-if="formValidate.image_watermark_status == 1">
                ...
                <div v-if="formValidate.watermark_type == 1">
                  <div class="flex">
                    <el-form-item class="contentIput" label="水印透明度：" prop="name">
                      <el-input
                        class="topIput"
                        type="number"
                    ...
                    <el-form-item class="contentIput" label="水印倾斜度：" prop="mail">
                      <el-input
                        class="topIput"
                        type="number"
                  ...
                  <div class="flex">
                    <el-form-item class="contentIput" label="水印图片：" prop="name">
                  ...
                  <div class="flex">
                    <el-form-item class="contentIput" label="水印横坐标偏移量：" width="200" prop="name">
                      <el-input
                        class="topIput"
                        type="number"
                    ...
                    <el-form-item class="contentIput" label="水印纵坐标偏移量：" prop="mail">
                      <el-input
                        class="topIput"
                        type="number"
                ...
                <div v-else>
                  <div class="flex">
                    <el-form-item class="contentIput" label="水印文字：" prop="name">
                      <el-input class="topIput" v-model="formValidate.watermark_text" placeholder="请输入水印文字">
                      </el-input>
                    </el-form-item>
                    <el-form-item class="contentIput" label="水印文字大小：">
                      <el-input
                        class="topIput"
                        type="number"
                  ...
                  <div class="flex">
                    <el-form-item class="contentIput" label="水印字体旋转角度：">
                      <el-input
                        class="topIput"
                        type="number"
                    ...
                    <el-form-item class="contentIput" label="水印横坐标偏移量：">
                      <el-input
                        class="topIput"
                        type="number"
                        v-model="formValidate.watermark_x"
                  ...
                  <el-form-item class="contentIput" label="水印横坐纵偏移量：" prop="mail">
                    <el-input
                      class="topIput"
                      type="number"
                      v-model="formValidate.watermark_y"
        ...
        >
          ...
          <el-table-column label="操作" fixed="right" width="220">
            <template slot-scope="scope">
              ...
              <el-divider direction="vertical"></el-divider>
              <span class="btn" @click="del(scope.row, '删除该数据', index)">删除</span>
            </template>
          </el-table-column>
        </el-table>
